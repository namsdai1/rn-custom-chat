...
//emoji
import EmojiPicker from "./src/emoji/EmojiPicker";
...
const BottomChat = (
  ...
  return (
    <View style={{ zIndex: 2 }}>
      <View style={[styles.containerBottomChat, {backgroundColor:colorBottomInput}]}>
        ...
        >
          ...
          >
            <TextInput
              ...
              multiline
              placeholder={placeholderInput?placeholderInput:"Messaging..."}
            ...
            >
              <FontAwesome5 name="smile" color={iconColor} size={22} />
            </TouchableOpacity>
          </View>
        </Animated.View>
        <Pressable
        ...
        >
          {txtMessages ? (
            <Ionicons name="send" color={iconColor} size={25} />
          ) : (
